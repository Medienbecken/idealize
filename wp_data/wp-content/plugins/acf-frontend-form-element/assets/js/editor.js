(function($) {
    $('body').on('click','.sub-fields-close', function() {
        $(this).removeClass('sub-fields-close').addClass('sub-fields-open');
        removePopup(type);
    });

    $('body').on('click', '.new-fea-form', function(event) {
        $link = $(this).data('link');

        window.open( $link, '_blank' );
    } );
    $('body').on('click', '.edit-fea-form', function(event) {
    ...
    $('body').on('click', '.sub-fields-open', function(event) {
        event.stopPropagation();
        type = $(this).data('type');
    ...
    $('body').on('click','.add-sub-field', function() {
