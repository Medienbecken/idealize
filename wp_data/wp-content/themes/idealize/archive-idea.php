				...
				<div id="inner-content" class="wrap cf">
					...
					<main id="main" class="m-all t-2of3 d-all cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
						...
						<h2 class="archive-title h2"><?php post_type_archive_title(); ?></h2>
							...
							<div class="d-1of3 cf" style="padding:1%;">
								...
								<header class="article-header">
                                    ...
                                    <?php } else {?>
                                        <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><img src="https://picsum.photos/seed/<?php the_ID(); ?>/200/125" alt="" style="width:100%;"></a>
                                    <?php }  ?>
